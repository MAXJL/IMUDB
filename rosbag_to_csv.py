...
if __name__ == "__main__":
    bag_file = '/home/jia/MA/IMUDB-main/EuRoC/bags/multiconv_48hidden_3heads_3layers/V2_01_easy.bag.new.imudb2.bag'  # 替换为您的bag文件路径
    output_csv = '/home/jia/MA/IMUDB-main/result/V201/Multi_wtconv48hidden_data.csv'  # 替换为您希望保存的csv文件路径

...
def train(config_fp='configs/euroc_imudb.yaml', checkpoint_path=None):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', type=str, default='configs/euroc_imudb.yaml', help='Path to the config file.')
    parser.add_argument('--checkpoint', type=str, help='Path to the checkpoint file to resume training from.')
    args = parser.parse_args()

    train(config_fp=args.config, checkpoint_path=args.checkpoint)
